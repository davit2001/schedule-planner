...
export async function POST(req: Request) {
    ...
    const historyMessages = appendClientMessage({
        messages: previousMessages as Message[],
        message: messages[messages.length - 1],
    });
    console.log('historyMessages', historyMessages)
    const result = streamText({
        system: 'Available courses are Data structures, Algorithms, and Operating systems. Please answer the question based on the course.',
